...
function JoinServer(sessionID: string, teamID: number) {
  client.send(
    JSON.stringify({
      command: "join-server",
...
const ActiveGame = ({ gameState }: ActiveGameProps) => {
  return (
    <div className="horizontal-fill">
...
const ActiveGames = ({ serverState }: ActiveGamesProps) => {
      ...
      if (currentgameID !== null) {
        ...
        setTimeout(() => {
          setGameData((currentGameData: { client_name: any; teams: { players: any[]; }[]; }) => {
            ...
            JoinServer(currentgameID, teamID ?? 2);
